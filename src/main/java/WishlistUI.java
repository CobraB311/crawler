...
public class WishlistUI extends JFrame {
    ...
    public JCheckBox bolCb, legoCb, amazonCb, dreamCb, fnacCb, supraCb, mediaCb, coolblueCb, kinderCb;
    ...
    private void setupUI() {
        ...
        kinderCb = new JCheckBox("Kinderplaneet");
        ...
        shopPanel.add(mediaCb); shopPanel.add(coolblueCb); shopPanel.add(kinderCb);
        left.add(shopPanel);
